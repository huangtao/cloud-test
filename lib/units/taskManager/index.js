...
module.exports = function () {
  ...
  var travelTestFile = path.resolve(__dirname, '../travel/testProcess.js')
      ...
      .then(function (device) {
        ...
        switch (testType){
          ...
          function startTravelTest(){
            var mLog = logger.createLogger('travelTest:'+task.taskid+':'+serial)
            mLog.debug('travel test')
            forkTest(travelTestFile,'travelTest',mLog)
          }
