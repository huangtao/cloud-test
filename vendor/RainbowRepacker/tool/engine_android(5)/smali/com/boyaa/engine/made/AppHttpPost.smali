.class public Lcom/boyaa/engine/made/AppHttpPost;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/boyaa/engine/made/AppHttpPost;->mMsgs:Ljava/util/HashMap;
    ...
    sput-object v0, Lcom/boyaa/engine/made/AppHttpPost;->mSyncMsgs:Ljava/lang/Object;
...
.method public static AddMsg(ILandroid/os/Message;)V
    ...
    .prologue
    .line 40
    sget-object v1, Lcom/boyaa/engine/made/AppHttpPost;->mSyncMsgs:Ljava/lang/Object;

    monitor-enter v1

    .line 42
    :try_start_0
    sget-object v0, Lcom/boyaa/engine/made/AppHttpPost;->mMsgs:Ljava/util/HashMap;
...
.method public static HandleTimeout(Landroid/os/Message;)V
    ...
    invoke-static {v2}, Lcom/boyaa/engine/made/AppHttpPost;->GetDictName(I)Ljava/lang/String;

    move-result-object v3

    .line 235
    .local v3, "strDictName":Ljava/lang/String;
    invoke-static {v2}, Lcom/boyaa/engine/made/AppHttpPost;->RemoveMsg(I)Landroid/os/Message;
    ...
    new-instance v5, Lcom/boyaa/engine/made/AppHttpPost$2;

    invoke-direct {v5, v2, v3, v1}, Lcom/boyaa/engine/made/AppHttpPost$2;-><init>(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static RemoveMsg(I)Landroid/os/Message;
    ...
    sget-object v3, Lcom/boyaa/engine/made/AppHttpPost;->mSyncMsgs:Ljava/lang/Object;

    monitor-enter v3

    .line 50
    :try_start_0
    sget-object v2, Lcom/boyaa/engine/made/AppHttpPost;->mMsgs:Ljava/util/HashMap;
...
.method static synthetic access$000(Lcom/boyaa/engine/made/AppHttpPost;)I
    .locals 1
    .param p0, "x0"    # Lcom/boyaa/engine/made/AppHttpPost;

    .prologue
    .line 34
    iget v0, p0, Lcom/boyaa/engine/made/AppHttpPost;->id:I

    return v0
.end method

.method static synthetic access$100(Lcom/boyaa/engine/made/AppHttpPost;)I
    .locals 1
    .param p0, "x0"    # Lcom/boyaa/engine/made/AppHttpPost;

    .prologue
    .line 34
    iget v0, p0, Lcom/boyaa/engine/made/AppHttpPost;->error:I

    return v0
.end method

.method static synthetic access$200(Lcom/boyaa/engine/made/AppHttpPost;)I
    .locals 1
    .param p0, "x0"    # Lcom/boyaa/engine/made/AppHttpPost;

    .prologue
    .line 34
    iget v0, p0, Lcom/boyaa/engine/made/AppHttpPost;->code:I

    return v0
.end method

.method static synthetic access$300(Lcom/boyaa/engine/made/AppHttpPost;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/boyaa/engine/made/AppHttpPost;

    .prologue
    .line 34
    iget-object v0, p0, Lcom/boyaa/engine/made/AppHttpPost;->ret:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$400(Lcom/boyaa/engine/made/AppHttpPost;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/boyaa/engine/made/AppHttpPost;

    .prologue
    .line 34
    iget-object v0, p0, Lcom/boyaa/engine/made/AppHttpPost;->event:Ljava/lang/String;
...
.method public Execute()V
    ...
    iput v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->id:I

    .line 102
    iget v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->id:I
    ...
    invoke-static {v3}, Lcom/boyaa/engine/made/AppHttpPost;->GetDictName(I)Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->event:Ljava/lang/String;
    ...
    iput v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->timeOut:I
    ...
    iput-object v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->url:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->data:Ljava/lang/String;

    .line 111
    iget v3, p0, Lcom/boyaa/engine/made/AppHttpPost;->timeOut:I

    if-ge v3, v6, :cond_1

    iput v6, p0, Lcom/boyaa/engine/made/AppHttpPost;->timeOut:I
    ...
    iget v4, p0, Lcom/boyaa/engine/made/AppHttpPost;->id:I
    ...
    iget-object v4, p0, Lcom/boyaa/engine/made/AppHttpPost;->event:Ljava/lang/String;
    ...
    iget v4, p0, Lcom/boyaa/engine/made/AppHttpPost;->timeOut:I
    ...
    invoke-static {v3, v1}, Lcom/boyaa/engine/made/AppHttpPost;->AddMsg(ILandroid/os/Message;)V
...
.method public run()V
    ...
    iput-object v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->ret:Ljava/lang/String;

    .line 139
    iput v9, p0, Lcom/boyaa/engine/made/AppHttpPost;->error:I

    .line 140
    iput v9, p0, Lcom/boyaa/engine/made/AppHttpPost;->code:I

    .line 142
    new-instance v5, Lorg/apache/http/client/methods/HttpPost;

    iget-object v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->url:Ljava/lang/String;
    ...
    iget v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->timeOut:I
    ...
    .line 150
    invoke-static {v3, v9}, Lorg/apache/http/params/HttpConnectionParams;->setTcpNoDelay(Lorg/apache/http/params/HttpParams;Z)V
    ...
    invoke-static {v0}, Lcom/boyaa/engine/made/AppHttpPost;->setProxy(Lorg/apache/http/client/HttpClient;)V
    ...
    iget v10, p0, Lcom/boyaa/engine/made/AppHttpPost;->timeOut:I
    ...
    iget-object v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->data:Ljava/lang/String;

    const-string v9, "UTF-8"

    invoke-direct {v2, v8, v9}, Lorg/apache/http/entity/StringEntity;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->code:I

    .line 167
    iget v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->code:I
    ...
    :goto_0
    iget v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->id:I

    invoke-static {v8}, Lcom/boyaa/engine/made/AppHttpPost;->RemoveMsg(I)Landroid/os/Message;
    ...
    invoke-static {v8}, Lcom/boyaa/engine/made/AppHttpPost;->GetDictName(I)Ljava/lang/String;

    move-result-object v7

    .line 196
    .local v7, "strDictName":Ljava/lang/String;
    invoke-static {}, Lcom/boyaa/engine/made/AppActivity;->getInstance()Lcom/boyaa/engine/made/AppActivity;

    move-result-object v8

    new-instance v9, Lcom/boyaa/engine/made/AppHttpPost$1;

    invoke-direct {v9, p0, v7}, Lcom/boyaa/engine/made/AppHttpPost$1;-><init>(Lcom/boyaa/engine/made/AppHttpPost;Ljava/lang/String;)V

    invoke-virtual {v8, v9}, Lcom/boyaa/engine/made/AppActivity;->runOnLuaThread(Ljava/lang/Runnable;)V

    .line 217
    .end local v7    # "strDictName":Ljava/lang/String;
    :cond_0
    return-void
    ...
    :try_start_2
    iput v8, p0, Lcom/boyaa/engine/made/AppHttpPost;->error:I
