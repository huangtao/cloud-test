...
local newObjectCaseSell=
{
	name="newObjectCaseSell",type=0,typeName="View",time=0,x=0,y=0,width=1280,height=720,visible=1,nodeAlign=kAlignTopLeft,fillParentWidth=1,fillParentHeight=1,stageW=0,
	{
	...
	},
	{
		...
		},
		{
			...
			{
				name="Button_sell",type=0,typeName="Button",time=108131048,x=0,y=38,width=190,height=80,nodeAlign=kAlignBottom,visible=1,fillParentWidth=0,fillParentHeight=0,file="hall/common/btns/btn_green_164x89_l25_r25_t25_b25.png",gridLeft=25,gridRight=25,gridTop=25,gridBottom=25,varname="Button_sell",callbackfunc="onBindToSell",
				{
			...
			{
				name="Image20",type=1,typeName="Image",time=0,x=0,y=230,width=300,height=56,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,file=backpack_qn_pin_map['backpack_sell_num_bg.png'],
				{
					name="Button_sub",type=1,typeName="Button",time=0,x=-35,y=2,width=71,height=66,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignLeft,file=backpack_qn_pin_map['backpack_sell_sub.png'],varname="Button_sub",callbackfunc="onBindSub"
				},
				{
			...
			{
				name="Image21",type=1,typeName="Image",time=0,x=0,y=150,width=222,height=49,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,file=backpack_qn_pin_map['backpack_sell_num_bg.png'],
				{
					name="Text25",type=4,typeName="Text",time=0,x=-40,y=0,width=30,height=34,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignLeft,fontSize=30,textAlign=kAlignLeft,colorRed=143,colorGreen=92,colorBlue=31,string=[[换]],colorA=1
				},
				{
			...
			{
				name="View23",type=0,typeName="View",time=0,x=-597,y=-90,width=659,height=325,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,fillBottomRightY=290,fillTopLeftX=0,fillBottomRightX=0,fillTopLeftY=0,
				{
					name="iconFrame",type=0,typeName="Image",time=108131050,x=0,y=-53,width=158,height=160,nodeAlign=kAlignCenter,visible=1,fillParentWidth=0,fillParentHeight=0,file=backpack_qn_pin_map['backpack_box.png'],varname="iconFrame",
					{
					...
					{
						name="Text_numOrday",type=0,typeName="Text",time=110051449,x=0,y=218,width=112,height=50,nodeAlign=kAlignTop,visible=1,fillParentWidth=0,fillParentHeight=0,string=[[数量：10]],fontSize=28,textAlign=kAlignCenter,colorRed=224,colorGreen=71,colorBlue=19,colorA=1,varname="Text_numOrday"
					}
				}
			}
		}
