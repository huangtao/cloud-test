local inviteViewWechatLayout=
{
	name="inviteViewWechatLayout",type=0,typeName="View",time=0,x=0,y=0,width=1280,height=720,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
		...
		{
			name="shareWechatView",type=0,typeName="View",time=106941360,x=0,y=0,width=598,height=720,nodeAlign=kAlignRight,visible=1,fillParentWidth=0,fillParentHeight=1,
			{
			...
			},
			{
				...
				{
					name="title",type=4,typeName="Text",time=0,x=0,y=0,width=128,height=36,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=32,textAlign=kAlignCenter,colorRed=159,colorGreen=115,colorBlue=50,colorA=1,string=[[微信邀请]]
				}
			},
			{
				...
				{
					name="img",type=1,typeName="Image",time=0,x=0,y=24,width=430,height=159,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="games/common/friend/invite_tips_wechat.png"
				},
				{
