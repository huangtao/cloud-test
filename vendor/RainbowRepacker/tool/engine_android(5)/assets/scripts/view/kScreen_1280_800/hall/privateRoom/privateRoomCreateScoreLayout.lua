local privateRoomCreateScoreLayout=
{
	name="privateRoomCreateScoreLayout",type=0,typeName="View",time=0,x=0,y=0,width=1280,height=720,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
	...
	},
	{
		...
		{
			name="contentView",type=0,typeName="View",time=0,x=0,y=0,width=999,height=260,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,
			{
				name="customView",type=0,typeName="View",time=0,x=0,y=0,width=999,height=260,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignCenter
			}
		}
	}
}
return privateRoomCreateScoreLayout;