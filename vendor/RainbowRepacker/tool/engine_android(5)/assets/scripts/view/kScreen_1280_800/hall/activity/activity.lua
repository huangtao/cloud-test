local activity=
{
	name="activity",type=0,typeName="View",time=0,report=0,x=0,y=0,width=0,height=0,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
	...
	{
		name="errorInfo",type=4,typeName="Text",time=58536154,report=0,x=0,y=0,width=240,height=30,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=36,textAlign=kAlignCenter,colorRed=255,colorGreen=250,colorBlue=200,string=[[活动列表获取失败]]
	}
}
return activity;