...
import {TestBundle} from 'appium-android-bootstrap'
...
helpers.startSettingApp = async function (adb) {
  logger.info("Starting " + SETTINGS_HELPER_PKG_ID);
...
helpers.initDevice = async function (adb, opts) {
  ...
  await helpers.startSettingApp(adb)
  return defaultIME;
};
